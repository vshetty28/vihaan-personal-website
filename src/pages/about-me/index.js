			...
			<div className="hero bg-inherit min-w-screen">
				<div className="hero-content flex-col lg:flex-row-reverse">
					...
					<div className="lg:px-20 lg:mx-10">
						<h1 className="p-4 text-3xl lg:text-6xl mb-4 text-center font-bold bg-gradient-to-t from-primary to-violet-900 text-transparent bg-clip-text tracking-wide"> About Me </h1>
