...
export const projects = [
	...
	{ id: 4, name: "Personal Website", description: "Personal website (this one!) built to showcase my projects, skills, and work experience, or in other words act as a personal portfolio. Implemented SEO optimization and custom animations for visual appeal, and hosted online using Vercel.", skills: ["React.js", "Next.js", "Tailwind CSS"], github: "https://github.com/vshetty28/vihaan-personal-website" },
