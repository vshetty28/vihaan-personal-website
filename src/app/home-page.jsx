...
const HomePage = () => {
	return (
		<div className="flex flex-col items-center place-items-center text-center w-screen justify-items-center px-4">
			<div>
				<motion.h1 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0, transition: { duration: 1, ease: "easeInOut" } }} className="text-nowrap text-xl lg:text-6xl m-4 p-2 bg-linear-to-r from-primary to-purple-400 text-transparent bg-clip-text">
