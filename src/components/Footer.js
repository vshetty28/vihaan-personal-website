			...
			<footer className="footer min-w-screen items-center justify-between px-6">
				...
				<div className="flex flex-row">
					...
					<a href="https://linkedin.com/in/vihaanshetty" target="_blank">
						<Image src="/assets/linkedin.svg" alt="" className="size-10 mt-2 mb-3 ml-4 lg:mb-0 lg:ml-2 lg:mt-4 transition delay-0 duration-200 ease-in-out hover:scale-110 " width={50} height={50} />
					</a>
				</div>
			</footer>
		</div>
