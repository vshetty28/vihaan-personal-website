...
const Project = ({ project }) => {
	return (
		<div className="flex flex-col h-full border-2 border-gray-700 rounded-md items-center justify-start pb-4 px-4 gap-3">
			<h1 className="text-3xl font-bold mt-4 bg-gradient-to-r from-purple-500 to-primary text-transparent bg-clip-text">{project.name}</h1>
			...
			<div className="flex-2 flex-grow text-center self-center">
