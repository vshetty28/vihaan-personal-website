...
const Skill = ({icon, text}) => {
  return (
		<div>
			<div className="group flex flex-row bg-base-300 p-1 px-2 items-center rounded-lg border-2 border-base-100 transition delay-0 duration-200 ease-in-out hover:border-2 hover:border-primary">
